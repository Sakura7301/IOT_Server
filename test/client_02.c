...
int main()
{
	...
	strcat(buf,"C45678");//客户端ID
	cJSON* cjson=cJSON_CreateObject();
	char *str=NULL;
	cJSON_AddStringToObject(cjson,"Equipment_0","E12345");//订阅ID为"E12345"的设备
	cJSON_AddStringToObject(cjson,"Equipment_1","E88888");//订阅ID为"E88888"的设备
